...
import { Layout, Menu, Icon, Spin, Row, Col, Button, Affix } from 'antd';
    ...
    render() { 
        return ( 
            <React.Fragment>
                  ...
                  <nav className="navbar navbar-expand-md navbar-dark bg-light">
                    ...
                    <div className="collapse navbar-collapse navbar-light" id="navbarsExample05">
                      <ul className="navbar-nav mx-auto">
                        ...
                        <li className="nav-item">
                          <AnchorLink href="#school-features"><a id="top-nav" className="nav-link" href="blog.html">Service</a></AnchorLink>
                        </li>

                        <li className="nav-item">
                          <AnchorLink href="#team-member"><a id="top-nav" className="nav-link" href="blog.html">Team</a></AnchorLink>
                        </li>

                        <li className="nav-item">
                          <AnchorLink href="#background2"><a id="top-nav" className="nav-link" href="blog.html">Testimonial</a></AnchorLink>
                        </li>

                        <li className="nav-item">
                          <AnchorLink href="#section-cover"><a id="top-nav" className="nav-link" href="about.html">Start</a></AnchorLink>
                        </li>
              ...
              {/*-----------------------------------------------------------------
                            Third Section - Service Introduction
                -------------------------------------------------------------------*/}
